...
A script that encapsulates all steps needed to learn and classify based on L1 normalized taylor features
"""
...
#project_taylor=true;
#init_bof_from_taylor_info=true;  # Not needed if bof_info.xml is accurate
#***************Stop here you need to make sure the bof_info.xml is accurate************************************#
#init_k_means=true;
#run_k_means=true;
init_categories_info=true; #initializes category label scenes and bof_categories_info.xml (if it doesn't exist)
#***************Stop here you need to make sure the bof_categories_info.xml is accurate**************************# 
...
do
    ...
    if $init_categories_info; then
      python /Projects/voxels-at-lems/scripts/dbrec3d/bof/taylor/learn_categories/init_category_info.py --bof_dir $bof_dir
    fi
