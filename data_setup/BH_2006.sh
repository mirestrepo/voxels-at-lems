...
# cd /data
# vlc --intf=rc --video-filter=scene --start-time=180 --scene-ratio=1 --scene-prefix=frame --scene-path=BH_2006/imgs vid15_brown_campus.m2t

#************Convert to jpg ************
# root_dir="/data/BH_2006/imgs"
...
# root_dir="/data/BH_2006"
# python $SCRIPTS_PATH/boxm2/boxm2_create_scene.py -c $root_dir/output_fixf_final.nvm -i "$root_dir/imgs" -a "boxm2_mog3_grey" -o "$root_dir/nvm_out" -p "$out_dir/scene_creation_log.txt"
