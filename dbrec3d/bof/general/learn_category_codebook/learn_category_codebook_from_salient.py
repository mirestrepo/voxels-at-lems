...
class bof_job():
    def __init__(self, categories, class_id , num_means, fraction, J, max_it, top_p, class_mean_dir):
...
#  #Begin multiprocessing
  ...
  for class_id in range (0, nclasses):
      ...
      current_job = bof_job(categories, class_id , num_means, fraction, J, max_it, top_p, class_mean_dir);
