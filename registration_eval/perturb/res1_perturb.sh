...
#2. Train the scene
# for trial in 9; do ./train_scenes.sh "res_east_side" "pert_005" $trial "png" 27 1; done
...
# for trial in 9; do ./compute_geometry.sh "res_east_side" "pert_005" $trial; done
...
# root_dir="/Users/isa/Experiments/reg3d_eval/res_east_side"
# t_basename="pert_005"
# ./reg3d_main.py --root_dir $root_dir --t_basename $t_basename --trial 1 --vis_ia true --descriptor "FPFH" --n_iter 500
