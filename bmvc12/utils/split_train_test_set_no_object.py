...
May 1, 2012
A script to randomly split the train/test samples
"""
import os
import sys
import random
...
if __name__=="__main__":
  ...
  for trial in range(0,5):
    ...
    train_file = trial_dir + "/bof_category_train_info_no_object.xml"
    test_file = trial_dir + "/bof_category_test_info_no_object.xml"
    ...
    for si in sites:
      ...
      categories = glob.glob(obj_dir + "/background_" + str(percentile));
