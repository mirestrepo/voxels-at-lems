...
#  import code; code.interact(local=locals())
  ...
  classes = ['Plane', 'Car', 'House', "Building", "Parking", "Background"];
...
#*************************************************************************
  ...
  avg_classification_dir = "/Users/isa/Experiments/bof_bmvc12/" + "/average_no_object/" + feature_name   + "/percentile_" + str(percentile)
  avg_classification_dir = avg_classification_dir + "/classification_no_object_" + str(K);
